        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="font-weight:bold;"> Tambah Data Outlet</h4>
                </div>
            
                <form action="{{ '/outlet'}}" method="POST">
                  @csrf
                <div class="card-body">
                  <p class="card-title" style="font-size:18px;">Form Tambah Data Outlet</p>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group ">
                        ...
                        <input type="text" name="name" id="name" class="form-control form-control-sm @error('name') is-invalid @enderror"  placeholder="Nama Outlet"  value="{{ old('name') }}" autocomplete="off" />
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone"  class="form-control form-control-sm @error('phone') is-invalid @enderror" placeholder="Nomor Telepon" autocomplete="off" value="{{ old('phone') }}"/>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group ">
                        ...
                        <input type="text" class="form-control form-control-sm @error('address') is-invalid @enderror" name="address" placeholder="Alamat Outlet" id="address" value="{{ old('address') }}" autocomplete="off" />
                      ...
                      <div class="form-control @error('isFaskes') is-invalid @enderror ">
                        ...
                        <div class="col-sm-6">
                          <div class="form-check-inline">
                            ...
                            <input type="radio" class="form-check-input" id="isFaskes" name="isFaskes"  value="1">Ya
                            </label>
                          </div>
                          <div class="form-check-inline">
                            <label class="form-check-label" for="rbTidak">
                            <input type="radio" class="form-check-input" id="isFaskes" name="isFaskes" value="0">Tidak
                            </label>
                          </div>
                        </div>
