        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" style="font-weight:bold;">Lihat Data Tindakan</h4>
                </div>
               ...
               @method('put')
               <div class="card-body">
                 <p class="card-title" style="font-size:18px;">Form Lihat Data Tindakan</p>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      -->
                        ...
                        <input disabled type="text" name="name" id="name" class="form-control form-control-sm @error('name') is-invalid @enderror"  placeholder="Nama Tindakan"  value="{{ $outlet->namaTindakan }}" autocomplete="off" />
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select disabled type="text" class="custom-select custom-select-sm" name="typeTindakan" id="typeTindakan" >
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      -->
                        ...
                        <input disabled type="text" class="form-control form-control-sm @error('description') is-invalid @enderror" name="description" placeholder="Deskripsi Tindakan" id="description" value="{{ $outlet->description }}" autocomplete="off" />
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select disabled type="text" class="custom-select custom-select-sm" name="spesimen" id="spesimen">
                ...
                <div class="row fieldGroup">
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <select disabled class="custom-select custom-select-sm" id="outlet" name="outlet[]">
                        <option value="">--Pilih Outlet--</option>     

                       <option value="{{ $item1->idOutlet }}" selected>{{ $item1->namaOutlet }}</option>
                  ...
                  <div class="col-md-3">
                    ...
                    -->
                      ...
                      <input disabled type="text" class="form-control form-control-sm  @error('price') is-invalid @enderror" name="price[]" placeholder="Harga Tindakan Di Tiap Outlet" id="price" value="{{ $item1->price }}" autocomplete="off" >
                      <!--
                      <font color="blue">
                        <b>Contoh: 75000
                        </b>
                ...
                <div class="row fieldGroupCopy" style="display: none" >
                  ...
                  <div class="col-md-3">
                    ...
                    -->
                      ...
                      <input disabled type="text" class="form-control form-control-sm  @error('price') is-invalid @enderror" name="price[]" placeholder="Harga Tindakan Di Tiap Outlet" id="price" value="{{ old('price') }}" autocomplete="off" >
                      <!--
                      <font color="blue">
                        <b>Contoh: 75000
                        </b>
